...
class TrafficLight:
    ...
    def __init__(self):
        ...
        self.MovingVehicle = MovingVehicle()
    ...
    def trafficLightInteraction (self, trafficLight, vehicles, timeSinceLastChange):
        ...
        if self.green_light == False:
            ...
            if distance > 0 & distance < self.MovingVehicle.decelerationDistance:
            ...
            elif distance > (self.MovingVehicle.stoppingDistance / 2) & distance < self.MovingVehicle.stoppingDistance:
