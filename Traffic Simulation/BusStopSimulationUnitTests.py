...
class TestBusStopSimulation(unittest.TestCase):
    ...
    def test_busStopSimulation_deceleration(self):
        ...
        vehicles = [{"road": "A", "type": "bus", "position": 10, "speed": 20, "acceleration": 0},
        ...
        self.assertAlmostEqual(vehicles[0]["acceleration"], VehicleCalculations.delayFactor * -1, places=5)
    ...
    def test_busStopSimulation_waitingTime(self):
        ...
        self.assertEqual(busStopCounter[0]["counter"], 50)
