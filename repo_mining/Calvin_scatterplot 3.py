            ...
            for shaObject in jsonCommits:
                ...
                for filenameObj in filesjson:    #NEED TO FILTER SOURCE FILES HERE
                    ...
                    if(ending == desiredEnding):       #if file ends in .java, add it
                        ...
                        #print(filename)
                        touchArray.append(touches)
                        filex = random.randint(1, 17)
                        fileArray.append(filex)
...
plt.scatter(fileArray, touchArray, c=touchArray, s=500, cmap='gray')
plt.show()
