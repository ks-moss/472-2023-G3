...
ifile = open('C:/Users/Cody/Documents/GitHub/472-2023-G3/repo_mining/data/file_rootbeer.csv',"rt")
    ...
    if len(row)>2:
        ...
        for i in range(loop1):
            ...
            if i % 2 != 0:
                ...
                plt.scatter(name_index, date_index*10, c=colors[index % len(colors)])
                index += 1
plt.xlabel("File")
plt.ylabel("Weeks")
plt.show()
